<x-app-layout>
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <div class="mt-5">
                <!-- BEGIN: Input -->
                <form action="{{ route('keberatan.update', $data->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div id="input">
                            <div class="p-5">
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <label for="nomor-permohonan" class="form-label font-medium">Nomor Keberatan
                                            Informasi</label>
                                        <input id="nomor-permohonan" type="text" class="form-control"
                                            value="{{ $data->no_keberatan_informasi }}" disabled>
                                    </div>
                                    <div class="mt-3">
